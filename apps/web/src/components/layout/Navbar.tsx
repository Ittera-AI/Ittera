...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      // Active zone: from 56px below top (below navbar) to 45% up from bottom
  ...
  const navBg = isDark
    ? "rgba(18, 16, 14, 0.65)" // Slightly lighter than background to stand out
                      ...
                      >
                        ...
                        <div className="p-1.5">
                          <Link
                            ...
                            style={{ color: isDark ? "rgba(242,237,232,0.85)" : "#171717" }}
                            onMouseEnter={(e) => {
                              (e.currentTarget as HTMLAnchorElement).style.background = isDark ? "#242019" : "#F5F5F4";
                            }}
                            onMouseLeave={(e) => {
                ...
                {user ? (
                  <>
                    <Link
                      href="/dashboard"
                      onClick={() => setMobileOpen(false)}
                      className="text-center text-[14px] font-medium py-3 rounded-xl transition-colors"
                      style={{
                        color: isDark ? "#F2EDE8" : "#171717",
                        border: `1px solid ${isDark ? "#2E2922" : "#EAEAEC"}`,
                        background: isDark ? "#1C1916" : "#F5F5F4",
                      }}
                    >
                      Open workspace
                    </Link>
