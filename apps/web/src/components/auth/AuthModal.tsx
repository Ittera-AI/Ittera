                  ...
                  <AnimatePresence>
                    {successMsg && (
                      <motion.p
                        ...
                        style={{
                          color: isDark ? "#A38A70" : "#8B7260",
                          background: isDark ? "rgba(163,138,112,0.08)" : "rgba(163,138,112,0.05)",
                          border: `1px solid ${isDark ? "rgba(163,138,112,0.15)" : "rgba(163,138,112,0.2)"}`
                        }}
                      >
                        {successMsg}
                      </motion.p>
